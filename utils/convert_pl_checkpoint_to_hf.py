...
from dialogbart import DialogBartForConditionalGeneration, DialogBartTokenizer
...
def convert_pl_to_hf(pl_ckpt_path: str, hf_src_model_dir: str, save_path: str) -> None:
    ...
    """
    hf_model = DialogBartForConditionalGeneration.from_pretrained(hf_src_model_dir)
    ...
    try:
        tok = DialogBartTokenizer.from_pretrained(hf_src_model_dir)
